const JSVG = {
    ...
    rotatePoly: (element,degrees) => element.setAttribute("transform",`rotate(${degrees} ${JSVG.centerOf(element).x} ${JSVG.centerOf(element).y})`),
    ...
    svgPoint(x, y){
        var pt = JSVG.createSVG().createSVGPoint()
        pt.x = x
        pt.y = y
        return pt
    }
